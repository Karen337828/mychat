...
func RedisMsg(c *gin.Context) {
	...
	entity.RespOKList(c.Writer, "ok", res)
}

func MsgHandler(c *gin.Context, ws *websocket.Conn) {
	for {
		msg, err := clients.Subscribe(c, "websocket")
		if err != nil {
...
func SearchFriends(c *gin.Context) {
	...
	entity.RespOKList(c.Writer, users, len(users))
}
...
func AddFriend(c *gin.Context) {
	...
	if code == 0 {
		entity.RespOK(c.Writer, code, msg)
	} else {
		entity.RespFail(c.Writer, msg)
	}
}
...
func CreateGroup(c *gin.Context) {
	...
	groupBasic := models.GroupBasic{}
	groupBasic.OwnerId = uint(ownerId)
	groupBasic.Name = name
	groupBasic.Icon = icon
	groupBasic.Desc = desc
	code, msg := models.CreateGroup(groupBasic)
	if code == 0 {
		entity.RespOK(c.Writer, code, msg)
	} else {
		entity.RespFail(c.Writer, msg)
...
func LoadGroup(c *gin.Context) {
	ownerId, _ := strconv.Atoi(c.Request.FormValue("ownerId"))
	//	name := c.Request.FormValue("name")
	data, msg := models.LoadGroup(uint(ownerId))
	if len(data) != 0 {
		entity.RespList(c.Writer, 0, data, msg)
	} else {
		entity.RespFail(c.Writer, msg)
	}
}
...
func JoinGroups(c *gin.Context) {
	...
	if data == 0 {
		entity.RespOK(c.Writer, data, msg)
	} else {
		entity.RespFail(c.Writer, msg)
	}
}
...
func FindByID(c *gin.Context) {
	...
	entity.RespOK(c.Writer, data, "ok")
}
